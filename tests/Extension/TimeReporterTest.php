...
final class TimeReporterTest extends TestCase
{
    ...
    {
        $eventTests = [
            ['testName' => 'tests/acceptance/bar/baz.php:testA', 'time' => 10.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testA', 'time' => 50.00,], // rerun
            ['testName' => 'tests/acceptance/bar/baz.php:testB', 'time' => 100.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testC', 'time' => 50.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testD', 'time' => 33.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testD', 'time' => 50.00,], // rerun
            ['testName' => 'tests/acceptance/bar/baz.php:testE', 'time' => 66.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testF', 'time' => 90.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testG', 'time' => 100.00,],
            ['testName' => 'tests/acceptance/bar/baz.php:testG', 'time' => 13.00,], //rerun
            ['testName' => 'tests/acceptance/bar/baz.php:testH', 'time' => 50.00,],
        ];
        ...
        $invokedCount = $this->exactly(\count($testEvents));

        // get test name by the TestEventMock
        $reporter
            ->expects($invokedCount)
            ->method('getTestName')
            ->willReturnCallback(function () use ($invokedCount, $testEvents) {
                return $testEvents[$invokedCount->numberOfInvocations() - 1]['testName'];
            });
